        ...
        <View style={sty.container} >
            <FlatList data={frecuencyTable.intervals} showsVerticalScrollIndicator={false}
                renderItem={p => <Row
                    ...
                    styleText={{ color: props.textColor ?? "#000" }}
                    index={p.index + 1} />}
            />
        </View>
        <Row arr={["total", frecuencyTable.sum("frequency_data"), frecuencyTable.sum("frequency"), frecuencyTable.sum("relative_frequency"), frecuencyTable.sum("acumulated_frequency"), frecuencyTable.sum("acumulated_relative_frequency")]} style={{ borderBottomWidth: 1, }} styleText={{ color: colorAccent }} index={1} indexl={frecuencyTable.intervals.length} />
        <Row arr={["min", frecuencyTable.min("frequency_data"), frecuencyTable.min("frequency"), frecuencyTable.min("relative_frequency"), frecuencyTable.min("acumulated_frequency"), frecuencyTable.min("acumulated_relative_frequency")]} style={{ borderBottomWidth: 0 }} styleText={{ color: props.textColor ?? "#000" }} index={1} indexl={""} />
        <Row arr={["max", frecuencyTable.max("frequency_data"), frecuencyTable.max("frequency"), frecuencyTable.max("relative_frequency"), frecuencyTable.max("acumulated_frequency"), frecuencyTable.max("acumulated_relative_frequency")]} style={{ borderBottomWidth: 0 }} styleText={{ color: props.textColor ?? "#000" }} index={1} indexl={""} />
