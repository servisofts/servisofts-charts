...
const describePieScale = (x, y, radius, startAngle, endAngle, maxAngle) => {

    radius = radius * ((endAngle - startAngle) / maxAngle)

    var start = Func.polarToCartesian(x, y, radius, endAngle);
    var end = Func.polarToCartesian(x, y, radius, startAngle);
    ...
    render() {
        ...
        const render_circles = () => {
            ...
            return arr.map(obj => {
                ...
                const p = <Path d={describePieScale(center, center, scale, currentAngle, currentAngle + angle, maxAngle)}
                    fill={obj.color}
                    stroke={obj.color}
                    {...this.props.style}
                    {...obj.style}
